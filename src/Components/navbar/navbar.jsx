...
import { Brandname, CloseButton, Logo, MenuButton, Nav, Navbars, NavButton, NavCart, NavItems, NavList, Navlogo, Navright, StyledMenuButton } from './navbar.styled';
  ...
  return (
    ...
    <Navbars>
      ...
      animate={control}>
        ...
        <Brandname to='/'>Baking Tales</Brandname>
