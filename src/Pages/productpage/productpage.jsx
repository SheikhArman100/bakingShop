...
const {title,img,price,_id,catagories}=item
...
const handleClick=()=>{
  if(!token.jwt){
    ...
    const product = { title,img, price,_id,catagories,quantity};
    ...
    <>
      ...
      animate={control}>
          ...
          <AddContainer>
            ...
            <Button onClick={handleClick} isInCart={isInCart}>{isInCart ? "Added" : "ADD TO CART"}</Button>
          </AddContainer>
        </InfoContainer>
